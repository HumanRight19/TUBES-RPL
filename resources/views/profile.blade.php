...
<head>
  ...
  <title>Plesir Solo - Profile</title>
...
<body>
  ...
  <main id="main"><!-- #main -->
    ...
    <section id="portfolio-details" class="portfolio-details">
        <header class="section-header" style="text-align: center; margin-top: 150px">
            <p>Profil</p>
        </header>
        <div class="container" data-aos="fade-up" data-aos-delay="400">
            <div class="row gy-4 col-lg-10">
                <div class="col-lg-8">
                    <header class="section-header" style="text-align: start; margin-bottom: 10px; margin-top: 70px">
                        <h2 style="font-size: 26px; text-transform: capitalize">Halo, Selamat Datang di Aplikasi Plesir Solo</h2>
                    </header>
                </div>
            </div>
            <div class="row gy-4 col-lg-11">
                <div class="col-lg-8">
                    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
                        <div>
                            <header class="section-header mb-4" style="text-align: start">
                                <p style="font-size: 20px; text-transform: capitalize">Nama</p>
                            </header>
                        </div>
                        <div class="col-lg-8">
                    ...
                    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
                        <div>
                            <header class="section-header mb-4" style="text-align: start">
                                <p style="font-size: 20px; text-transform: capitalize">Email</p>
                            </header>
                        </div>
                        <div class="col-lg-8">
                    ...
                    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
                        <div>
                            <header class="section-header mb-4" style="text-align: start">
                                <p style="font-size: 20px; text-transform: capitalize">Nomor Telepon</p>
                            </header>
                        </div>
                        <div class="col-lg-8">
                    ...
                    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
                        <div>
                            <header class="section-header mb-4" style="text-align: start">
                                <p style="font-size: 20px; text-transform: capitalize">Alamat</p>
                            </header>
                        </div>
                        <div class="col-lg-8">
